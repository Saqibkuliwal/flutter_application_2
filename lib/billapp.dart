...
import 'package:flutter_application_2/pages/bil.dart';
...
class _billappState extends State<billapp> {
  ...
  getAllappoint() async {
    ...
    String url =
        "http://${ip}/workshopp/api/customer/billappointment?mobile_no=$number";
  ...
  showAppointments() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        appointno = show![index]["Appoitment_no"].toString();
