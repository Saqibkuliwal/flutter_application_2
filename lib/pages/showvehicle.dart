...
class _showVehicleState extends State<showVehicle> {
  ...
  getAllVehicle() async{
     SharedPreferences prefrence2 = await SharedPreferences.getInstance();
      ...
      String url="http://192.168.137.1/workshopp/api/customer/allVehicles?mobile_no=$number";
  ...
  return ListView.builder(
    ...
    itemBuilder: (context,index){
      return Container(
        ...
        child: Center(
          child: ListTile(
            leading:Text(vehicleList![index]["name"],style: TextStyle(fontSize: 27,
            ...
            title: Center(
              ...
              children: [
                ...
                Text(vehicleList![index]["reg_no"],style: TextStyle(fontSize: 26,
            color:Colors.redAccent)),
             Text('Vehicle Color'),
                Text(vehicleList![index]["color"],style: TextStyle(fontSize: 26,
            color:Colors.redAccent)),
            
              ],
            ),
          ),
          onTap: ()async{Navigator.push(context, MaterialPageRoute(builder: (context)=>Appointment()));
